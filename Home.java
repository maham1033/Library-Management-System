...
public class Home extends javax.swing.JFrame {
    ...
    public Home() {
        initComponents(); //sets up the Swing components (buttons, labels, panels, etc.) for your GUI.
        setTitle("Library Management System");
        setResizable(false); // JFrame is not resizable
        setLocationRelativeTo(null); //positioned at the center of the screen when the application is run.
    }
